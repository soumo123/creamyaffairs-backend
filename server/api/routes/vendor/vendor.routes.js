...
const { addVendor,addAgent, getAllVendors, getallAgents, addInventory, getTransctions, updateStock, updateMoney, viewTransaction, barCodeProduct,viewVendorAgent, requestOrder, getAllRequstedOrders, searchagentandvendors, getReqordersSpecificAgents,updateAgentStatus, updateVendorStatus} = require('../../controllers/vendor-agents.controller.js');
...
router.put('/update_vendor_status',updateVendorStatus)
